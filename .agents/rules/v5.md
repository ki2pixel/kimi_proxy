...
- **JSON Data Handling**: Pour les fichiers JSON volumineux, interdiction de les lire entièrement (`read_file`). Utilise `json_query_query_json` (outil MCP JSON Query **local uniquement**, pas disponible dans Continue) ou l'API proxy.
