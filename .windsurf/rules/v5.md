...
- **Note importante**: Les outils MCP Phase 4 (shrimp-task-manager, sequential-thinking, fast-filesystem, json-query) sont maintenant disponibles directement dans Windsurf via le bridge.
