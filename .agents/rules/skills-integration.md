...
```
read_file(".agents/skills/[SKILL_NAME]/SKILL.md")
```
...
- **Local Skills** (`.agents/skills/`) : kimi-proxy-config-manager, kimi-proxy-frontend-architecture, kimi-proxy-mcp-integration, kimi-proxy-performance-optimization, kimi-proxy-streaming-debug, kimi-proxy-testing-strategies, shrimp-task-manager, sequentialthinking, fast-filesystem, json-query
